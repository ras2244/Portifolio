<?php 
	...
	// Template Name: single_fluid_container_down
	get_header();
?>
<?php
...
?>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<?php echo $contentValue['content1'] ;?>
			</div>
	...
	<div class="container-fluid cst-no-padding" >
		
		<!-- Main Content -->
		<div class="row cst-background-image" style="background-image: url('<?php echo $contentValue[background_img]['url']; ?>')">
			<?php

				/** contents in a background image */
				if($contentValue[background_img]['url']){
					...
					if($contentValue['has_styled_links'] == true){

						/** echo out the data from repeater*/
						while ( have_rows('add_styled_links') ) : the_row();
					    	...
					    	*/
							...
							//print the sub fields within a div-'row'
							echo "
							<div class='row  cst-link-bg-colour'>
								<div class='col-xs-6'>
									<h3>$title</h3>
								</div>
								<div class='col-xs-6 cst-right' >
									<a href='$link'><img class='learnMore_img' src='".get_template_directory_uri()."/src/images/icon/learnMoreBtnContent.png' alt='Learn More'></a>
								</div>
							</div>
							";
					    endwhile;
				...
				/** contents with images/text */
				if($contentValue['column'] == "col-md-6"){
					echo "
						<div class='col-sm-6'>
				...
				if($contentValue['column'] == "col-md-12" && !$contentValue[background_img]['url']){
					echo "
						<div class='col-sm-12'>
							".$contentValue['content2']."
						</div>
