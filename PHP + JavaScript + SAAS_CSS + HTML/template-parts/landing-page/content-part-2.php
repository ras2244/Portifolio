...
<!-- Query category post -->
<?php query_posts('category_name=alexa-frontpage-content-2'); ?>
<?php if(have_posts() ):?>


<!--First part content-->
<div class="row cst-part-content part-2" >
...
<?php  get_template_part('template-parts/landing-page/static_content/content-part-2'); ?>
