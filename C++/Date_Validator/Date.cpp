...
// Author	Ricardo Leal
// Description
// This program implements the Date class where the it uses
// Operators to test and validate if the input date is correct
// if it is no, the program will not allow and ask for a new date.
/////////////////////////////////////////////////////////////////
#include <iostream>
