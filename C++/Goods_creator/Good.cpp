...
// Author	Ricardo Leal
// Description
// This program implements the Good class where it register a new good
// with SKU, name, price,quantity and tax.
// its is also possble make copy of goods, compare and manage all itens of
// goods class testing operator =, == and +=
/////////////////////////////////////////////////////////////////
