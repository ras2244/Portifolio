...
// on shelf tester Program
// File	oop_ms4.cpp
// Version 2.1
// Date	2016/11/20
// Author	Ricardo Leal
// Description 
// This program test the implementation of all classe snce now (Date,
// good,Error) and add a test to 2 new classes customMade and Onshelf
// the program gonna run through a addition of a Good asking for 
// inputs to fill all good items and test each one,then the program 
// will store the on file. OnShelf and custom made will be used to 
// customize a information of a good and to print out a good linear or
// as a form, customMade will add the date when the goods was delivered.
/////////////////////////////////////////////////////////////////
